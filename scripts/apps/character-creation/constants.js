...
export const TAB_GUIDANCE = {
  ...
  traits: "Distribute your 5 attribute points and 12 skill points. Start with d6 in each attribute, then boost what matters for your character. Core skills (marked FREE) start at d4—you just pay to boost them. Other skills cost points to use. Each die step up (d4→d6) costs 1 point.",
