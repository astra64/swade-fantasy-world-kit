...
1. **v0.6.0: Character Manager — Unified Character Creation & Advancement Tools** — Build SWADE character creation support plus guided advancement automation for hassle-free campaign progression.
   ...
   - **Status (v0.6.0 Phase 1)**: Concept, Ancestry, Hindrances, and Traits (Attributes & Skills) tabs complete and tested. Template modularized into Handlebars partials for maintainability. Ancestry bonuses automatically detected from ability effects with lock minimums. Skill and attribute descriptions displayed on hover. Remaining: Edges, Gear, Summary tabs.
