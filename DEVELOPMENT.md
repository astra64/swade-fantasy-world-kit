...
1. **v0.6.0: Character Manager — Unified Character Creation & Advancement Tools** — Build SWADE character creation support plus guided advancement automation for hassle-free campaign progression.
   ...
   - **Status (v0.6.0 Phase 1)**: Concept, Ancestry, and Hindrances tabs complete and tested. Template modularized into Handlebars partials for maintainability. Remaining: Attributes & Skills, Edges, Gear, Summary tabs.
